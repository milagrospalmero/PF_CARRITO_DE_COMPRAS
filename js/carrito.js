        ...
        if (productos.length == 0) {
           ...
           <th class='text-center'>Precio</th>
            ...
            for (const producto of productos) {
                ...
                <td class='text-center'><button class='btn btn-dark' onclick='eliminarProducto(${producto.id});' title='Eliminar Producto'>-</button> <b>${producto.cantidad}</b> <button class='btn btn-dark' onclick='agregarProducto(${producto.id});' title='Agregar Producto'>+</button></td>
